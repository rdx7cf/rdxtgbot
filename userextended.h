...
public:
    ...
    UserExtended(bool b = false, std::int64_t ms = std::time(nullptr)) : blocked(b), member_since(ms) {}
    UserExtended(const TgBot::User::Ptr& tgu, bool b = false, std::time_t ms = std::time(nullptr)) : TgBot::User(*tgu), blocked(b), member_since(ms) {}
